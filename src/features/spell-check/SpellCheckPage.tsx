...
const SpellingCheckPage = () => {
  ...
  return (
    <>
     <Typography variant='h3' sx={{mt: 2, textAlign : 'center'}}> {t("spellingCheck")}</Typography>
      <Box sx={{ m: 3 }}>
        <Grid container spacing={5}>
          <Grid item xs={6} >
            ...
            <Box sx={{ mt: 1 }}>
              {
                !listening ?
                  <Button variant="contained" endIcon={<MicNoneIcon />} onClick={handleStartListening}>
                    {t("startRecording")}
                  </Button>
                  :
                  <Button variant="contained" endIcon={<RadioButtonCheckedIcon />} onClick={handleStopListening}>
                    {t("stopRecording")}
                  </Button>
              }
